...
import { createDoctorAction } from "@/app/(dashboardLayout)/admin/dashboard/doctors-managment/_action"
...
import { ICreateDoctorFormValues } from "@/zod/doctor.validation"
          ...
          <div className="px-6 py-5">
            ...
            >
              <div className="grid gap-4 md:grid-cols-2">
                <form.Field
                  name="name"
                  validators={{ onChange: createDoctorFormZodSchem.shape.name }}
                >
                  {(field) => (
                    <AppField
                      field={field}
